  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      ...
      children: [
        ...
        Image.asset("assets/coffe.png",package: "flutter_donation_buttons",width: 30,height: 30):
        Image.asset("assets/coffe2.png",package: "flutter_donation_buttons",width: 30,height: 30),
        Text(text,style: TextStyle(color: color!=BuyMeACoffeColor.Yellow? Colors.white : Colors.black,fontWeight: FontWeight.bold),),
      ]),
