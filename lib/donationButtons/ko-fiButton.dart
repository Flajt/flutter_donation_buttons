...
class KofiButton extends StatelessWidget {
  ...
  const KofiButton({Key? key,this.text="Support me on Ko-fi",required this.kofiName,this.kofiColor=KofiColor.Blue}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String,Color> _colors = {"KofiColor.Blue":Color(0xff29ABE0),"KofiColor.Red":Color(0xffFF5E5B),"KofiColor.Orange":Color(0xffFBAA19),"KofiColor.Black":Color(0xff434B57)};
    ...
    }, icon: Icon(SimpleIcons.kofi), label: Text(text),style: ElevatedButton.styleFrom(primary: _colors[kofiColor.toString()]),);
  }
}